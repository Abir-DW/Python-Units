...
# Demonstrates the Strategy Design Pattern in Python
# ==========================================================
...
# ABC is used to create Abstract Classes
from abc import ABC, abstractmethod

# functools is used while creating decorators
import functools

# uuid generates a unique transaction ID
import uuid

# datetime stores current date and time
...
# Every successful or failed payment returns a Receipt object.
...
class Receipt:
    ...
    # __str__ allows us to print the object directly.
    def __str__(self):
...
# ==========================================================
# Concept:
# Decorators add extra functionality before and after
# a function executes.
...
# Concept:
# Strategy Pattern
# The processor does not know HOW payment happens.
# It simply asks the current strategy to perform payment.

class PaymentProcessor:

    # Class Variable
    # Registry stores all available payment methods.
